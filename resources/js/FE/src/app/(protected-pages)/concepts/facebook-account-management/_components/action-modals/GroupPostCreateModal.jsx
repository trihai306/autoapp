...
const GroupPostCreateModal = ({ isOpen, onClose, action, onSave }) => {
    ...
    return (
        <Dialog isOpen={isOpen} onClose={onClose} onRequestClose={onClose} width={800}>
            <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
                <div>
                    <h5 className="font-bold text-lg">Đăng bài lên nhóm (Facebook)</h5>
                </div>
...
export default GroupPostCreateModal
