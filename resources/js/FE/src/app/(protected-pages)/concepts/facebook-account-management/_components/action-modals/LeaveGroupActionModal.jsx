...
/**
 * Modal cấu hình hành động "Rời nhóm" cho kịch bản
 * Modal này lưu cấu hình vào scenario
 */
const LeaveGroupActionModal = ({ isOpen, onClose, onSave, actionData }) => {
            ...
            <div className="flex items-center gap-3 mb-6">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-500 dark:text-gray-400">
                        Thiết lập các nhóm để rời khỏi trong kịch bản
                    </p>
                </div>
            </div>
...
export default LeaveGroupActionModal
