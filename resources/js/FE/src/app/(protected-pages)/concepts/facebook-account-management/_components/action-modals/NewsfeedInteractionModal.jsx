...
const NewsfeedInteractionModal = ({ isOpen, onClose, action, onSave }) => {
    ...
    return (
        <Dialog isOpen={isOpen} onClose={onClose} onRequestClose={onClose} width={760}>
            <div className="p-6 space-y-6 max-h-[75vh] overflow-y-auto">
                <div>
                    <h5 className="font-bold text-lg">Tương tác Newsfeed (Facebook)</h5>
                    <p className="text-sm text-gray-500 mt-1">Chọn hành động và kho bình luận áp dụng cho comment trên newsfeed.</p>
                </div>
                ...
                <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4 space-y-3">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <div>
                            <label className="block text-sm font-medium mb-1">Số bài tối đa</label>
                            <Input type="number" value={form.maxPosts} onChange={(e)=>setForm(p=>({ ...p, maxPosts: Number(e.target.value)||0 }))} />
                        </div>
                        <div>
...
export default NewsfeedInteractionModal
