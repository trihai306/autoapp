            ...
            <Container className="relative">
                <div className="py-10 md:py-40">
                    ...
                    >
                        ...
                        >
                            <h2 className="text-5xl">Bắt đầu với AgentAI ngay hôm nay</h2>
                            <p className="mt-4 max-w-[400px] mx-auto">
                                Bắt đầu xây dựng các agent AI tự động của bạn ngay bây giờ và cách mạng hóa quy trình làm việc của bạn.
                            </p>
                            <div className="mt-6">
